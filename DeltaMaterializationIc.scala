...
//Dm query
val df10=sqlContext.sql("SELECT Subject,Predicate,Object from TableWithoutPartitions where version='v1' MINUS SELECT Subject,Predicate,Object from TableWithoutPartitions where version ='v5'").write.saveAsTable("DELETEv1v5")



val df11=sqlContext.sql("SELECT Subject,Predicate,Object from TableWithoutPartitions where version='v5' MINUS SELECT Subject,Predicate,Object from TableWithoutPartitions where version ='v1'").write.saveAsTable("ADDv1v5")

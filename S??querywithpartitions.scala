...
//S?? query
val df10=sqlContext.sql("SELECT Subject,Predicate,Object from TableWithPartitions  where version ='v5' and Subject='<acct:nicoletta@beta.teamlife.it#acct>'").write.saveAsTable("TableS??")

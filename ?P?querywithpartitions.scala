...
//?P? query
val df10=sqlContext.sql("SELECT Subject,Predicate,Object from TableWithPartitions  where version ='v5' and Predicate='<http://rdfs.org/sioc/ns#account_of> '").write.saveAsTable("Table?P?")

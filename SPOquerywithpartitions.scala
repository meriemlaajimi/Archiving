...
//SPO query
val df10=sqlContext.sql("SELECT Subject,Predicate,Object from TableWithPartitions  where version ='v5'and Subject='<acct:nicoletta@beta.teamlife.it#acct>' and Predicate='<http://rdfs.org/sioc/ns#account_of> ' and Object='<acct:nicoletta@beta.teamlife.it>'").write.saveAsTable("TableSPO")
